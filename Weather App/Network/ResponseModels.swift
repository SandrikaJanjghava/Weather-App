...
struct Weather: Codable {
    ...
    var icon: String
    var iconUrl: URL? {
        let url = URL(string: String(format: NetworkConstants.iconUrl, self.icon))
        return url
    }
}
...
extension Result: ForecastWeatherType, CurrentWeatherType {}
